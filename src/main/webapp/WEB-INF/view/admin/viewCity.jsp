  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">SHSAD | View City</h4>
		    <ol class="breadcrumb">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> VIEW CITY</div>
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <c:forEach items="${cityList}" var="i" varStatus="count">
							<tr>
							...
							<td><div class="form-footer">
										<button type="submit" class="btn btn-success m-1"><a href="editCity?editCityId=${i.id}"><font color="white"><b>Edit</b></font></a></button>
							<button type="submit" class="btn btn-danger m-1"><a href="deleteCity?deleteCityId=${i.id}"><font color="white"><b>Delete</b></font></a></button>		
							</div></td>
							</tr>
							</c:forEach>
                </tbody>
