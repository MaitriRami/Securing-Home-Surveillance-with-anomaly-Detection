...
<head>
  ...
  <title>SHSAD | View Complain</title>
  <!--favicon-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">SHSAD | View Complain</h4>
		    <ol class="breadcrumb">
 ...
 -->     </div>
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> VIEW COMPLAIN</div>
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <c:forEach items="${complainList}" var="i" varStatus="count">
                    <tr>
                    	<td>${count.count}</td>
                        ...
                        <c:if test="${i.complainStatus eq 'Pending'}">
							<button type="submit" class="btn btn-success"><a href="complainReply?complainReplyId=${i.id}"><font color="white"><b>Reply</b></font></a></button>
						</c:if>	
						<c:if test="${i.complainStatus ne 'Pending'}">
						<span class="btn btn-primary btn-round m-1">Resolved</span>
						</c:if>	
					</div></td>
                    </tr>
                    </c:forEach>
