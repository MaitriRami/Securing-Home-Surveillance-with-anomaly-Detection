		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add Reply</h4>
						<ol class="breadcrumb">
							
							<li class="breadcrumb-item"><a href="javaScript:void();">Manage Reply</a></li>
							<li class="breadcrumb-item active" aria-current="page">Add Reply
								</li>
						</ol>
					</div>
					<!-- <div class="col-sm-3">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="replyComplain.html" modelAttribute="complainVO" method="post">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> Reply of complain
									</h4>
									<div class="form-group row">
										<label for="input-5" class="col-sm-2 col-form-label">Complain Subject</label>
										<div class="col-sm-10">
											<f:input path="complainSubject"  class="form-control" id="input-5"
												readonly="true" />
										</div>
									</div>
									<div class="form-group row">
										<label for="input-9" class="col-sm-2 col-form-label">Complain Description</label>
										<div class="col-sm-10">
											<f:textarea path="complainDescription" class="form-control" rows="4" id="input-9" readonly="true"></f:textarea>
										</div>
									</div>
									<div class="form-group row">
										<label for="input-9" class="col-sm-2 col-form-label">Reply</label>
										<div class="col-sm-10">
											<f:textarea path="reply" class="form-control" rows="4" id="input-9"></f:textarea>
										</div>
									</div>
									<f:input path="id" type="hidden"/>
									<f:input path="complainTime" type="hidden"/>
									<f:input path="loginVO.id" type="hidden"/>
