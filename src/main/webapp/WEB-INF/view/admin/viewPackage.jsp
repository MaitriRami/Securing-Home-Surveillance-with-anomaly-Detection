  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">SHSAD | View Package</h4>
		    <ol class="breadcrumb">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> VIEW PACKAGE</div>
            <div class="card-body">
                ...
                <c:forEach items="${packageList}" var="i" varStatus="count">
                    <tr>
                        ...
                        <td><div class="form-footer">
							<button type="submit" class="btn btn-success m-1"><a href="editPackage?editPackageId=${i.id}"><font color="White"><b>Edit</b></font></a></button>
							<button type="submit" class="btn btn-danger m-1"><a href="deletePackage?deletePackageId=${i.id}"><font color="White"><b>Delete</b></font></a></button>	
					</div></td>
                    </tr>
                    </c:forEach>
                </tbody>
