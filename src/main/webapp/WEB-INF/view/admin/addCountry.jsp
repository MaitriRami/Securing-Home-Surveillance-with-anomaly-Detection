		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add Country</h4>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="insertCountry.html" modelAttribute="countryVO" method="post">
								<f:input type="hidden" path="id"/>
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> ADD COUNTRY
									</h4>
									<div class="form-group row">
										<label for="input-5" class="col-sm-2 col-form-label">Country</label>
										<div class="col-sm-10">
											<f:input  class="form-control"  path="countryName" />
										</div>
									</div>
									<div class="form-group row">
										<label for="input-9" class="col-sm-2 col-form-label">Description</label>
										<div class="col-sm-10">
											<f:textarea class="form-control" rows="4" 
												path="countryDescrption" ></f:textarea>
										</div>
									</div>
