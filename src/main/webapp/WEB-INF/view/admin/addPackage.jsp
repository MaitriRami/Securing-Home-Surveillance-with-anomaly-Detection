		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add Package</h4>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="javaScript:void();">Manage Packages</a></li>
							<li class="breadcrumb-item active" aria-current="page">Add Packages
								</li>
						</ol>
					</div>
					<!-- <div class="col-sm-3">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="insertPackage" method="post" modelAttribute="packageVO">
								<f:input type="hidden" path="id"/>
 									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> ADD PACKAGE
									</h4>
									<div class="form-group row">
						                  <label for="input-6" class="col-sm-2 col-form-label">Package Name</label>
						                  <div class="col-sm-10">
									...
									<div class="form-group row">
										<label for="input-5" class="col-sm-2 col-form-label">Package Duration</label>
										<div class="col-sm-10">
											<f:input type="text" class="form-control" id="input-5"
									...
									<div class="form-group row">
										<label for="input-9" class="col-sm-2 col-form-label">Package Price</label>
										<div class="col-sm-10">
											<f:input type="text" class="form-control" id="input-5"
												path="packagePrice"/>
										</div>
