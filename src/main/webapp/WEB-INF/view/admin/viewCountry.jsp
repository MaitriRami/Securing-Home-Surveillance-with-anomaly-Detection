...
<head>
  ...
  <title>SHSAD | View Country</title>
  <!--favicon-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">SHSAD | View Country</h4>
		    <ol class="breadcrumb">
            
            <li class="breadcrumb-item"><a href="javaScript:void();">Manage Country</a></li>
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> VIEW COUNTRY</div>
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <c:forEach items="${countryList }" var="i" varStatus="count">
                    <tr>
                    	<td><c:out value="${count.count }" /></td>
                        <td>${i.countryName }</td>
                        <td>${i.countryDescrption }</td>
                        <td><div class="form-footer">
							<button type="submit" class="btn btn-success m-1"><a href="editCountry?editCountryId=${i.id}"><font color="white"><b>Edit</b></font></a></button>
							<button type="submit" class="btn btn-danger m-1"><a href="deleteCountry?deleteCountryId=${i.id}"><font color="white"><b>Delete</b></font></a></button>	
					</div></td>
                    </tr>
                    </c:forEach>
                </tbody>
