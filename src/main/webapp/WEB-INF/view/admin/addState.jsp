		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add State</h4>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="insertState.html" method="post" modelAttribute="stateVO">
								<f:input type="hidden" path="id"/>
									...
									<div class="form-group row">
										<label for="input-5" class="col-sm-2 col-form-label">Add State</label>
										<div class="col-sm-10">
