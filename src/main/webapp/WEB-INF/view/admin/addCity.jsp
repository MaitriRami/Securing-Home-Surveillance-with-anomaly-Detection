		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add City</h4>
						<ol class="breadcrumb">
							<!-- <li class="breadcrumb-item"><a href="javaScript:void();">Xmino</a></li> -->
							<li class="breadcrumb-item"><a href="javaScript:void();">Manage City</a></li>
 ...
 -->				</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="insertCity" method="post" modelAttribute="cityVO">
								<f:input path="id" type="hidden"/>
									...
									<div class="form-group row">
						                  ...
						                  <div class="col-sm-10">
						                    <f:select class="form-control" id="country" path="countryVO.id" onChange="getState()">
						                      <!--    <c:forEach items="${Model.countryList}" var="i">
												<option value="${i.id}">${i.countryName}</option>
												</c:forEach>-->
												<f:option value="${cityVO.countryVO.id}" label="Select"></f:option>
									...
									<div class="form-group row">
						                  ...
						                  <div class="col-sm-10">
						                    <f:select class="form-control" id="state" path="stateVO.id">
						                        <%-- <c:forEach items="${Model.stateList}" var="i">
												<option value="${i.id}">${i.stateName}</option>
												</c:forEach> --%>
												<f:option value="${cityVO.stateVO.id}">${cityVO.stateVO.stateName}</f:option>
												
												</f:select>
						                  </div>
						                </div>
								<div class="form-group row">
										<label for="input-5" class="col-sm-2 col-form-label">Add City</label>
										<div class="col-sm-10">
											<f:input type="text" class="form-control" id="input-5"
												path="cityName" />
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<f:textarea class="form-control" rows="4" id="input-9"
												path="cityDescription"></f:textarea>
										</div>
									</div>
