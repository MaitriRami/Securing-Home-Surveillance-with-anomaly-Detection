...
<script type="text/javascript">
    function addcamera()
    {
        ...
        var a=t.insertRow(-1);
        var d1=a.insertCell();
        d1.innerHTML="<div class='form-group row'><label for='input-5' class='col-sm-2 col-form-label'>Camera IP</label><div class='col-sm-10'><input type='text' class='form-control' id='input-5'style='width:700px' placeholder='IP Address'></div></div>";
    }
    </script>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add Camera</h4>
						<ol class="breadcrumb">
							<!-- <li class="breadcrumb-item"><a href="javaScript:void();">Xmino</a></li> -->
							<li class="breadcrumb-item"><a href="javaScript:void();">Manage Camera</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="insertCamera.html" method="post" modelAttribute="cameraVO">
								<f:input path="id" type="hidden"/>
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> ADD Camera
									</h4>
									<div class="form-group row">
						                  <label for="input-6" class="col-sm-2 col-form-label">Select Country</label>
						                  <div class="col-sm-10">
						                    <f:select class="form-control" id="input-6" path="countryVO.id">
									...
									<div class="form-group row">
						                  <label for="input-6" class="col-sm-2 col-form-label">Select State</label>
						                  <div class="col-sm-10">
						                    <f:select class="form-control" id="input-6" path="stateVO.id">
						               ...
						               <div class="form-group row">
						                  <label for="input-6" class="col-sm-2 col-form-label">Select City</label>
						                  <div class="col-sm-10">
						                    <f:select class="form-control" id="input-6" path="cityVO.id">
						                 ...
						                 <div class="form-group row">
                 			 <label for="input-1" class="col-sm-2 col-form-label">Camera IP</label>
                  				<div class="col-sm-10">
                    			<f:input path="cameraIP" class="form-control" id="input-1"  style="width:700px" placeholder="IP Address" />
                  						<button class="btn btn-success" onclick="addcamera()"  type="submit" style="margin-left:717px;margin-top:-61px;">+</button>
										</div>
									</div>
									
									<table id="table" style="display: none;width:1020px;"></table>
