...
<head>
  ...
  <title>SHSAD | View Dataset</title>
  <!--favicon-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">SHSAD | View Dataset</h4>
		    <ol class="breadcrumb">
            
            <li class="breadcrumb-item"><a href="javaScript:void();">Manage Dataset</a></li>
            <li class="breadcrumb-item active" aria-current="page">View Dataset</li>
         </ol>
	   </div>
	   <!-- <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> VIEW DATASET</div>
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <c:forEach items="${datasetList}" var="i" varStatus="count">
                    <tr>
                    	<td><c:out value="${count.count}" /></td>
                        <td>${i.datasetName}</td>
                        <td>${i.datasetLink }</td>
                        <td><div class="form-footer">
							<button type="submit" class="btn btn-success m-1"><a href="deleteDataset?deleteDatasetId=${i.id}"><font color="white"><b>Delete</b></font></a></button>	
					</div></td>
                    </tr>
                    </c:forEach>
                </tbody>
