...
<title>SHSAD | Add Feedback</title>
<!--favicon-->
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">SHSAD | Add Feedback</h4>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<f:form id="personal-info" action="insertFeedback" modelAttribute="feedbackVO" method="post">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i>ADD FEEDBACK
									</h4>
									
									<f:input path="id" type="hidden" />
									
									<div class="form-group row">
										<label for="input-9" class="col-sm-2 col-form-label">Feedback</label>
										<div class="col-sm-10">
											<f:textarea class="form-control" rows="4" id="input-9" path="feedBack"
												name="aboutuser" />
										</div>
								
									
    								<!-- <h4> <span class="flaticon-house-key"></span>Rating</h4> -->
    									<label for="input-9" class="col-sm-2 col-form-label">rating</label>
										<div class="rating">
									...
									<br><br>
										<button type="submit" style="margin-left:-136px;margin-top:-54px;" class="btn btn-success">
