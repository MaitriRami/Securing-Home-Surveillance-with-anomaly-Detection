  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">SHSAD | View Family</h4>
		    <ol class="breadcrumb">
            
            <li class="breadcrumb-item"><a href="javaScript:void();">Manage Family</a></li>
            <li class="breadcrumb-item active" aria-current="page">View Family</li>
         </ol>
	   </div>
	  <!--  <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>VIEW FAMILY MEMBER
            </div>
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <c:forEach items="${familyPhotoList}" var="i" varStatus="j">
                <tbody>
                    <tr>
                        <td>${j.count}</td>
                        <td>${i.memberName}</td>
                        <td><a href="<%=request.getContextPath()%>/Doc/multipleFile/${i.fileName}">view</a></td>
                        <td>
						<button type="submit" class="btn btn-danger m-1"><a href="deletePhoto?deletePhotoId=${i.id}">
						<font color="White"><b>Delete</b></font></a></button>
                        </td>
                    </tr>
                </tbody>
                </c:forEach>
